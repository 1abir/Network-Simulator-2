...
END {
    ...
    #varying,   throughput,    end_to_end_delay,   delivery_ratio,     #drop_ratio
    print vari,",",(received_bytes * 8) / simulation_time, ",", (total_delay / received_packets),",",(received_packets / sent_packets),",",(dropped_packets / sent_packets) ;
